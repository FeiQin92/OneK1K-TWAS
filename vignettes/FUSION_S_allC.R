...
FUNSION <- function(opt){
	...
	#opt$out = paste0(dir, cancer_type, "_fusion/output_FT_no_inflat/", tiss_name_ID, "_", ID_for_chr, "_output")
...
FUNSION(opt=data.frame(sumstats=paste0("/gpfs/gsfs12/users/qinf2/OneK1K/TWAS/logCPM/model/GWAS/", cancer_type, "_fusion/Melanoma_fusion.txt"), 
                       out=paste0(dir, cancer_type, "_fusion/output_S_allC/", tiss_name_ID, "_", ID_for_chr, "_output"), 
